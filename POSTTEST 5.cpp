...
int    search        (dataPengunjung struk[], string tipeKamar)		 		;
...
int search(dataPengunjung struk[], int nomor){
	...
	// Penggunaan for untuk menuju semua data
	for (int i = 0; i <= 50; i++){
...
void checkin(dataPengunjung struk[]){
	...
	int slot = search(struk, tipeKamar)				;
